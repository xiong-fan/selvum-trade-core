...
public enum TransactionType implements BaseEnum {
	...
	RED_OUT("红包发出"),
	RED_IN("红包领取"),
    TRANSFER_TO_TRADING("划入交易账户"),
    TRANSFER_FROM_TRADING("划出交易账户");
    ...
    public static TransactionType valueOfOrdinal(int ordinal){
        switch (ordinal){
            ...
            case 17:return TRANSFER_TO_TRADING;
            case 18:return TRANSFER_FROM_TRADING;
            default:return null;
        }
    }
    public static int parseOrdinal(TransactionType ordinal) {
        if (TransactionType.RECHARGE.equals(ordinal)) {
            ...
            return 16;
        }else if (TransactionType.TRANSFER_TO_TRADING.equals(ordinal)) {
            return 17;
        }else if (TransactionType.TRANSFER_FROM_TRADING.equals(ordinal)) {
            return 18;
        }else {
            return 20;
        }
